  ...
  return (
    <div className="container sm:64 md:my-32 sm:my-32">
      ...
      <p className="text-gray-500 text-sm">
        Akya Butik olarak, veri sorumlusu sıfatıyla, mevzuattan kaynaklanan
        yasal yükümlülüklerimiz çerçevesinde; markalarımızın hizmetlerinden
        faydalanabilmeniz, onayınız halinde kampanyalarımız hakkında sizleri
        bilgilendirmek, öneri ve şikayetlerinizi kayıt altına alabilmek, sizlere
        daha iyi hizmet standartları oluşturabilmek, Voyant ticari ve iş
        stratejilerinin belirlenmesi ve uygulanması gibi amaçlarla kişisel
        verilerinizi sözlü, internet sitesi, sosyal medya mecraları, mobil
        uygulamalar ve benzeri vasıtalarla sözlü, yazılı ya da elektronik
      ...
      <p className="text-gray-500 text-sm">
        Akya Butik olarak, veri sorumlusu sıfatı ile çağrı merkezlerimiz, yazılı
        iletişim kanallarımız, sosyal medya sayfalarımız, mobil iletişim
        kanalları, mağaza içi iletişim kanalları ve/veya bunlarla sınırlı
        olmamak üzere her türlü kanallar aracılığı ile; onayınız dahilinde elde
        ettiğimiz kişisel ve/veya özel nitelikli kişisel verileriniz tamamen
        veya kısmen elde edilebilir, kaydedilebilir, saklanabilir,
        depolanabilir, değiştirilebilir, güncellenebilir, periyodik olarak
        ...
        halinde kampanyalarımız hakkında sizleri bilgilendirmek, öneri ve
        şikayetlerinizi kayıt altına alabilmek, sizlere daha iyi hizmet
        standartları oluşturabilmek, Voyant ticari ve iş stratejilerinin
        belirlenmesi ve uygulanması gibi amaçlarla ve her halükarda 6698 sayılı
        Kişisel Verilerin Korunması Kanunu ve ilgili mevzuata uygun olarak
      ...
      <p className="text-gray-500 text-sm">
        Akya Butik, söz konusu kişisel verilerinizi sadece; açık rızanıza
        istinaden veya kanunda belirtilen güvenlik ve gizlilik esasları
        çerçevesinde yeterli önlemler alınmak kaydıyla yurt içinde ve gerekli
        güvenlik önlemlerinin alınması kaydıyla yurt dışında, şirket
        faaliyetlerinin yürütülmesi, veri sahipleri ile müşterilerimiz
        arasındaki iş ilişkisinin sağlanması ve/veya bu amaçla görüşmeler
        yapılması, hizmetler, fırsat ve olanaklar sunulması ve hizmet
        kalitesinin artırılması amacıyla; grup şirketlerimiz, iş ortaklarımız,
        faaliyetlerimizin gereği anlaşmalı olduğumuz ve hizmet sunduğumuz
        müşteriler, tedarikçiler, denetim şirketleri veya yasal bir zorunluluk
        gereği bu verileri talep etmeye yetkili olan kamu kurum veya
      ...
      <p className="text-gray-500 text-sm">
        ...
        bilgileriniz, siteden alışveriş yapan siz değerli müşterilerimizin
        güvenliğini en üst seviyede tutmak amacıyla hiçbir şekilde Akya Butik
        veya ona hizmet veren şirketlerin sunucularında tutulmamaktadır. Bu
        şekilde ödemeye yönelik tüm işlemlerin Akya Butik arayüzü üzerinden
      ...
      <p className="text-gray-500 text-sm">
        ...
        amacıyla çerezleri sitelerimizin kullanımı hakkında istatistiksel
