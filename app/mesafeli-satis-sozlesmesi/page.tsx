...
export default function page() {
  return (
    <div className="container sm:64 md:my-32 sm:my-32">
      ...
      <h3 className="text-lg font-bold">1. SORUMLULUKLAR </h3>
      <p>
        a. Akya Butik, fiyatlar ve sunulan ürün ve hizmetler üzerinde değişiklik
        yapma hakkını her zaman saklı tutar.
      </p>
      <p>
        b. Akya Butik, üyenin sözleşme konusu hizmetlerden, teknik arızalar
      ...
      <p>
        ...
        tutar. Bu sebeple yargı mercilerinden etkinlik veya kullanıcı hesapları
        ile ilgili bilgi talepleri gelirse paylaşma hakkını saklı tutar.
      </p>
      <h3 className="text-lg font-bold mt-6">2. FİKRİ MÜLKİYET HAKLARI</h3>
      <p>
        a. Site’de yer alan ünvan, işletme adı, marka, patent, logo, tasarım,
        bilgi ve yöntem gibi tescilli veya tescilsiz tüm fikri mülkiyet hakları
        site işleteni ve sahibi firmaya veya belirtilen ilgilisine ait olup,
        ulusal ve uluslararası hukukun koruması altındadır.
      </p>
      <p>
        b. Site’de yer alan bilgiler hiçbir şekilde çoğaltılamaz, yayınlanamaz,
      ...
      <h3>3. GİZLİ BİLGİ</h3>
      <p>
        a. Firma, site üzerinden kullanıcıların ilettiği kişisel bilgileri 3.
      ...
      <p>
        b. Kullanıcı, sadece tanıtım, reklam, kampanya, promosyon, duyuru vb.
        ...
        ile paylaşmasına muvafakat ettiğini kabul ve beyan eder. Bu kişisel
        bilgiler firma bünyesinde müşteri profili belirlemek, müşteri profiline
        uygun promosyon ve kampanyalar sunmak ve istatistiksel çalışmalar yapmak
        amacıyla kullanılabilecektir.
      </p>
      <p>
        c. Gizli Bilgiler, ancak resmi makamlarca usulü dairesinde bu bilgilerin
      ...
      <p>
        d. Garanti Vermeme: İŞBU SÖZLEŞME MADDESİ UYGULANABİLİR KANUNUN İZİN
        ...
        KONUSUNDA TÜM ZIMNİ GARANTİLER DE DÂHİL OLMAK ÜZERE HİZMETLER VEYA
        UYGULAMA İLE İLGİLİ OLARAK (BUNLARDA YER ALAN TÜM BİLGİLER DÂHİL) SARİH
        VEYA ZIMNİ, KANUNİ VEYA BAŞKA BİR NİTELİKTE HİÇBİR GARANTİDE
        BULUNMAMAKTADIR.
      </p>
      <h2 className="mt-6">* Kayıt ve Güvenlik</h2>
      <p className="text-gray-500 text-sm">
        Kullanıcı, doğru, eksiksiz ve güncel kayıt bilgilerini vermek
        zorundadır. Aksi halde bu Sözleşme ihlal edilmiş sayılacak ve Kullanıcı
        bilgilendirilmeksizin hesap kapatılabilecektir. Kullanıcı, site ve
        üçüncü taraf sitelerdeki şifre ve hesap güvenliğinden kendisi
      ...
      <h2 className="mt-6">* Mücbir Sebep</h2>
      <p className="text-gray-500 text-sm">
      ...
      <h2 className="mt-6">* Sözleşmenin Bütünlüğü ve Uygulanabilirlik</h2>
      <p className="text-gray-500 text-sm">
        Sözleşme şartlarından biri, kısmen veya tamamen geçersiz hale gelirse,
        sözleşmenin geri kalanı geçerliliğini korumaya devam eder.
      </p>
      <h2 className="mt-6">* Sözleşmede Yapılacak Değişiklikler</h2>
      <p className="text-gray-500 text-sm">
        ...
        yayınlandığı tarihten itibaren geçerli olacaktır. Değişiklikleri takip
        etmek Kullanıcı’nın sorumluluğundadır. Kullanıcı, sunulan hizmetlerden
        yararlanmaya devam etmekle bu değişiklikleri de kabul etmiş sayılır.
      </p>
      <h2 className="mt-6">* Tebligat</h2>
      <p className="text-gray-500 text-sm">
        Sözleşme ile ilgili taraflara gönderilecek olan tüm bildirimler,
        Firma’nın bilinen e.posta adresi ve kullanıcının üyelik formunda
        belirttiği e.posta adresi vasıtasıyla yapılacaktır. Kullanıcı, üye
      ...
      <h2 className="mt-6">* Kullanım Şartları</h2>
      <p className="text-gray-500 text-sm">
        Web sitemiz üzerinden istisnasız her alışverişi yapan ve satın alma
        işlemini başarıyla tamamlayan kullanıcılarımız kullanım şartlarını ve bu
        sözleşmeyi kabul etmektedir.
      </p>
    </div>
  );
}
